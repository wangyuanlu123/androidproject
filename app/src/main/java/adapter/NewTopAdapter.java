...
public class NewTopAdapter extends RecyclerView.Adapter<NewTopAdapter.MyViewHolder> implements View.OnClickListener {
    ...
    public NewTopAdapter(Context context, ArrayList<NewTop.New> list) {
        this.list = list;
